"""
Django settings for dockerized_django_demo_circleci project.
...
APPS_DIR = ROOT_DIR / "dockerized_django_demo_circleci"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "dockerized_django_demo_circleci.contrib.sites.migrations"}
...
ADMINS = [("""Alice Bob Charlie""", "alice_bob_charlie@example.com")]
